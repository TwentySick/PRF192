...
int countDigit(int n){ //n = 23; n=2, count = 1; n = 2/ 10 = 0, count = 2
	int count = 0;
	while(n > 0){
		n = n / 10;
		count++;
...
int isArmstrong(int n){
	...
	original = n;
	digit = countDigit(n); // n = 23 => digit = 2
	while(n > 0){
		sum += pow(n % 10, digit); // n = 23 => sum1 = 23 % 10 ^ 2 + 0 = 3 ^ 2;
		n = n / 10;					// n = n / 10 = 23 / 10 = 2; sum2 = 3^2 + 2^2 = 13; return 0;
	}
